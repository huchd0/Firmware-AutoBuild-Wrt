...
BASE_PACKAGES="base-files block-mount default-settings-chn luci-i18n-base-zh-cn"
...
# 重点 2：回归官方正统架构，开启 squashfs，关闭 ext4
